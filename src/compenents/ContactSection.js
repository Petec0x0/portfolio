                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 md:gap-12">
                        ...
                        <form className="p-6 flex flex-col justify-center">
                            ...
                            <div className="flex flex-col mt-2">
                                ...
                                <input type="email" name="email" id="email" placeholder="Email" className="w-100 mt-2 py-3 px-3 rounded-lg bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none" />
                            </div>

                            <div className="flex flex-col mt-2">
                                <label htmlFor="tel" className="hidden">Message</label>
                                <textarea className="w-100 mt-2 py-3 px-3 rounded-lg bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none" placeholder="Message">
