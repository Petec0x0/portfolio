...
import ims_web from 'images/ims-web.png';
        ...
        <div id="portfolio" className="bg-body py-8 px-12">
            ...
            <div className="flex flex-col md:flex-row-reverse justify-center">
                <div className="p-4 md:w-1/2 lg:w-1/3">
                    <img src={ims_web} alt="IMS WEB" />
                </div>
                <div className="md:p-4 md:w-1/2">
                    <h2 className="text-white font-bold text-xl md:px-4 md:py-6">IMS Web</h2>
                    ...
                    <div className="flex flex-row py-2 md:px-4">
                        ...
                        <img className="mx-1" src={tailwindcss} height={20} width={20} alt="Tailwind CSS" />
            ...
            <div className="flex flex-col md:flex-row justify-center">
                ...
                <div className="md:p-4 md:w-1/2">
                    ...
                    <div className="flex flex-row md:px-4">
                        ...
                        <a title="Demo Link" className="flex items-center mx-2 text-white hover:text-primary" href="/#">
                            <PopupLinkIcon />
                        </a>
                    </div>
                </div>
